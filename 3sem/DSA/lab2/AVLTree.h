...
struct avltree *avltree_add(struct avltree *root, char key, void *value);
struct avltree *avltree_lookup(struct avltree *root, char key);
struct avltree *avltree_delete(struct avltree *root, char key);
